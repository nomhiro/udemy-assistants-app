...
class CosmosPageObj:
    ...
    def __str__(self):
        return f'id: {self.id}, page_number: {self.page_number}, content: {self.content}, keywords: {self.keywords}, file_name: {self.file_name}, delete_flag: {self.delete_flag}, is_contain_image: {self.is_contain_image}, image_blob_path: {self.image_blob_path}'